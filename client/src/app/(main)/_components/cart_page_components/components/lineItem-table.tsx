...
interface LineItemTableProps<TData, TValue> {
...
export function LineItemTable<TData, TValue>({
  ...
  const table = useReactTable({
    ...
    onRowSelectionChange: setLineItemSelection,
