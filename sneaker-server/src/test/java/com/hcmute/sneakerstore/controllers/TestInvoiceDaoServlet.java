...
import com.hcmute.sneakerstore.data.DAOs.InvoiceDao;
...
public class TestInvoiceDaoServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                ...
                try {
                        ...
                        // Test insertMany
                        Invoice newInvoice2 = Invoice.builder().paymentTime(LocalDateTime.parse("2017-11-15T08:22:11"))
                                        .address(Location.builder().city("haah").country("hehe").district("hic")
                                                        .build())
                                        .build();
                        Invoice newInvoice3 = Invoice.builder().paymentTime(LocalDateTime.parse("2017-11-15T08:22:10"))
                                        .address(Location.builder().city("haah").country("hehe").district("hic")
                                                        .build())
                                        .build();
                        Invoice newInvoice4 = Invoice.builder().paymentTime(LocalDateTime.parse("2017-11-15T08:22:12"))
                                        .address(Location.builder().city("haah").country("hehe").district("hic")
                                                        .build())
                                        .build();
                        Invoice newInvoice5 = Invoice.builder().paymentTime(LocalDateTime.parse("2017-11-15T08:22:12"))
                                        .address(Location.builder().city("haah").country("hehe").district("hic")
                                                        .build())
                                        .build();
                        ...
                        output.append("selectOne: ").append(Invoice != null ? Invoice.toString() : "No Invoice found")
                                        .append("\n");

                        // Test selectMany
                        List<Invoice> Invoices = InvoiceDao.selectMany();
                        output.append("selectMany: ")
                                        .append(Invoices != null ? Invoices.toString() : "No Invoices found")
                                        .append("\n");
                        ...
                        output.append("selectManyByIds: ")
                                        .append(InvoicesByIds != null ? InvoicesByIds.toString() : "No invoices found")
                                        .append("\n");
                        ...
                        output.append("selectMany after updateOne: ")
                                        .append(Invoices != null ? Invoices.toString() : "No Invoice found")
                                        .append("\n");
                        //
                        // Test updateMany
